  ...
  return (
    <Section>
      <div className="grid grid-cols-12">
        <FeaturedProjectGalleryItem href="/projects" text="Residential Spaces" imgSrc="images/img4.jpg" style="col-span-6" />
        <FeaturedProjectGalleryItem href="/projects" text="Public Spaces" imgSrc="images/img5.jpg" style="col-span-6"  />
